...
EMPTY_INPUT_MESSAGE = {
  eng: '<br>You need to enter the number',
  ukr: '<br>Введіть число',
  ru: '<br>Введите число'
}.freeze

WRONG_INPUT_MESSAGE = {
  eng: 'WRONG INPUT<br> Enter the number from 0 to 100',
...
get '/' do
  ...
  erb game.lang.to_sym, locals: { attempt: game.attempt_number, message_case: game.message_case }
end
